      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Link href={isAuthenticated ? "/services" : "/login"} className="group">
              <div className="bg-card border rounded-xl p-8 hover:shadow-lg transition-shadow">
                ...
                <p className="text-muted-foreground">
                  Complete event coordination from concept to execution.
                </p>
              </div>
            </Link>
            ...
            <Link href={isAuthenticated ? "/services" : "/login"} className="group">
              <div className="bg-card border rounded-xl p-8 hover:shadow-lg transition-shadow">
                ...
                <p className="text-muted-foreground">
                  Delicious menus crafted for any occasion.
                </p>
              </div>
            </Link>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="bg-primary text-primary-foreground rounded-2xl p-12 md:p-16 text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg mb-8 opacity-90">
              Create an account today and book your perfect event.
            </p>
            <Button asChild size="lg" variant="secondary" className="text-lg">
              <Link href={isAuthenticated ? "/services" : "/signup"}>
                {isAuthenticated ? "Explore Services" : "Create Account"}
              </Link>
            </Button>
          </div>
        </div>
